...
version: 1.20.0
source-hash: b4ac71bb8487c986
---

# aiad-sdd — Documentation utilisateur (v1.20.0)
...
```
aiad-sdd v1.20.0 — Spec Driven Development pour Claude Code
  https://aiad.ovh
...
*Document régénéré automatiquement — source-hash `b4ac71bb8487c986`, package v1.20.0.*
