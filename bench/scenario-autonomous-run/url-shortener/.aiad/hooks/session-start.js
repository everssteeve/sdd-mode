...
function main() {
  ...
  // Rappel JNSP en clôture — affiché à chaque session pour ancrer le réflexe
  // "tu peux dire je ne sais pas". Forme courte intentionnelle (budget contexte).
  lines.push('[AIAD] Garde-fou JNSP : si l\'intention est floue, un critère non testable ou un fichier illisible, réponds `JNSP : <question pour l\'humain>` plutôt qu\'inventer. Dans le code : `// TODO-JNSP: <question>` — le pre-commit bloque tant qu\'il en reste.');
