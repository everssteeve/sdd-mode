---
name: gouvernance
description: Vérifier la conformité d'un livrable aux 5 agents de gouvernance Tier 1
---
...
**Recommandation modèle** : Opus 4.8 ou Sonnet 4.6 — analyse réglementaire Tier 1 (AI-ACT, RGPD, RGAA, RGESN, CRA).
👉 `/model claude-opus-4-8` — conformité réglementaire Tier 1 (haute précision recommandée).
> Fallback : `/model claude-sonnet-4-6` pour une vérification de pré-conformité.
...
| **AIAD-CRA** | Cybersécurité produit | Règlement (UE) 2024/2847 (Cyber Resilience Act, application 2027) | `.aiad/gouvernance/AIAD-CRA.md` |
...
Affiche : *"Cette vérification réglementaire Tier 1 est plus efficace avec Opus 4.8 ou Sonnet 4.6. Si tu n'es pas sur l'un de ces modèles, considère de basculer (`/fast` pour Opus dans Claude Code)."*
