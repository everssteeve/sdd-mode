...
export function calculerVeto(projetDir, fichiers) {
  ...
  for (const f of fichiers) {
    ...
    // Les définitions d'agents de gouvernance sont elles-mêmes la source
    // des annotations — les soumettre au veto serait circulaire.
    if (f.startsWith('.claude/agents/') || f.startsWith('.aiad/gouvernance/')) continue;
