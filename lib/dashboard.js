...
import { calculerVelocityComparison } from './dashboard/velocity-comparison.js';
import { calculerWipLimit } from './dashboard/wip-limit.js';
import { calculerBacklogFreshness } from './dashboard/backlog-freshness.js';
import { calculerGoalTree } from './dashboard/goal-tree.js';
import { calculerAbTestTracker } from './dashboard/ab-test-tracker.js';
import { calculerRiskBurndown } from './dashboard/risk-burndown.js';
import { calculerOutcomeLeaderboard } from './dashboard/outcome-leaderboard.js';
import { calculerVelocityForecast } from './dashboard/velocity-forecast.js';
import { calculerAiActCompliance } from './dashboard/ai-act-compliance.js';
import { calculerNotifications } from './dashboard/notification-center.js';
import { calculerSqsReadiness } from './dashboard/sqs-readiness.js';
import { calculerHealthTimeline } from './dashboard/health-timeline.js';
import { calculerIntentMaturity } from './dashboard/intent-maturity.js';
import { genererNarratif } from './dashboard/strategic-narrative.js';
import { calculerSprintPlanner } from './dashboard/sprint-planner.js';
import { calculerStakeholderComms } from './dashboard/stakeholder-comms.js';
import { calculerDecisionVelocity } from './dashboard/decision-velocity.js';
import { calculerWeeklyChecklist } from './dashboard/pm-weekly-checklist.js';
import { calculerOutcomeAttribution } from './dashboard/outcome-attribution.js';
import { calculerDiscoveryDeliveryBalance } from './dashboard/discovery-delivery-balance.js';
import { calculerVelocityBySponsor } from './dashboard/velocity-by-sponsor.js';
import { calculerPrdFreshness } from './dashboard/prd-freshness.js';
import { calculerCustomerFeedback } from './dashboard/customer-feedback.js';
import { calculerWhatsNew } from './dashboard/whats-new.js';
import { calculerHypothesisLifecycle } from './dashboard/hypothesis-lifecycle.js';
import { calculerRoadmapTimeline } from './dashboard/roadmap-timeline.js';
import { calculerPmScorecard } from './dashboard/pm-scorecard.js';
import { calculerIntentCompare } from './dashboard/intent-compare.js';
import { calculerSponsorPrep } from './dashboard/sponsor-prep.js';
import { calculerBacklogHygiene } from './dashboard/backlog-hygiene.js';
import { calculerTimeToFirstSpec } from './dashboard/time-to-first-spec.js';
import { calculerCustomerVoiceWall } from './dashboard/customer-voice-wall.js';
import { calculerQuarterlyDelivery } from './dashboard/quarterly-delivery.js';
import { calculerReviewQueue } from './dashboard/review-queue.js';
import { calculerAcceptedRisks } from './dashboard/accepted-risks.js';
import { calculerWinsWall } from './dashboard/wins-wall.js';
import { calculerStateTransitions } from './dashboard/state-transitions.js';
import { calculerOrphanDeps } from './dashboard/orphan-deps.js';
import { calculerDemoAgenda } from './dashboard/demo-agenda.js';
import { calculerSpecStuck } from './dashboard/spec-stuck.js';
import { calculerTagClusters } from './dashboard/tag-clusters.js';
import { calculerCostOfDelay } from './dashboard/cost-of-delay.js';
import { calculerBacklogPyramid } from './dashboard/backlog-pyramid.js';
import { calculerSpecCrossIntent } from './dashboard/spec-cross-intent.js';
import { calculerBlockerReminders } from './dashboard/blocker-reminders.js';
import { calculerPersonaOutcomeMatrix } from './dashboard/persona-outcome-matrix.js';
import { calculerThroughputTrend } from './dashboard/throughput-trend.js';
import { calculerRiskConcentration } from './dashboard/risk-concentration.js';
import { calculerDiscoveryToDelivery } from './dashboard/discovery-to-delivery.js';
import { calculerOwnerWorkload } from './dashboard/owner-workload.js';
import { calculerReadingTime } from './dashboard/reading-time.js';
import { calculerSpecScope } from './dashboard/spec-scope.js';
import { calculerGoalAlignment } from './dashboard/goal-alignment.js';
import { calculerVelocitySla } from './dashboard/velocity-sla.js';
import { calculerDoneTimeline } from './dashboard/done-timeline.js';
import { calculerPrdSectionsCoverage } from './dashboard/prd-sections-coverage.js';
import { calculerOutcomeCompletion } from './dashboard/outcome-completion.js';
import { calculerRiskTransparency } from './dashboard/risk-transparency.js';
import { calculerCumulativeAchievements } from './dashboard/cumulative-achievements.js';
import { calculerStandupScript } from './dashboard/standup-script.js';
import { calculerQuarterlyRetroDraft } from './dashboard/quarterly-retro-draft.js';
import { calculerPrdCoverageGaps } from './dashboard/prd-coverage-gaps.js';
import { calculerSpecAnnotationCoverage } from './dashboard/spec-annotation-coverage.js';
import { calculerPortfolioDiversity } from './dashboard/portfolio-diversity.js';
import { calculerDowHeatmap } from './dashboard/dow-heatmap.js';
import { calculerPrTemplate } from './dashboard/pr-template.js';
import { calculerVelocityByTag } from './dashboard/velocity-by-tag.js';
import { calculerAutoArchiveCandidates } from './dashboard/auto-archive-candidates.js';
import { calculerSprintRecap } from './dashboard/sprint-recap.js';
import { calculerAcceptanceCriteria } from './dashboard/acceptance-criteria.js';
import { calculerActionItems } from './dashboard/action-items.js';
import { calculerOkrProgress } from './dashboard/okr-progress.js';
import { calculerBusFactor } from './dashboard/bus-factor.js';
import { calculerSentimentTrend } from './dashboard/sentiment-trend.js';
import { calculerRitualsCalendar } from './dashboard/rituals-calendar.js';
import { calculerNewcomerChecklist } from './dashboard/newcomer-checklist.js';
import { calculerPendingDecisions } from './dashboard/pending-decisions.js';
import { calculerStakeholderMap } from './dashboard/stakeholder-map.js';
import { calculerQuarterlyDecisions } from './dashboard/quarterly-decisions.js';
import { calculerSpecQualityScore } from './dashboard/spec-quality-score.js';
import { calculerSponsorScorecard } from './dashboard/sponsor-scorecard.js';
import { calculerOutcomeNorthStar } from './dashboard/outcome-north-star.js';
import { calculerActivityFeed } from './dashboard/activity-feed.js';
import { calculerInitiativeCards } from './dashboard/initiative-cards.js';
import { calculerSpecLifecycleTime } from './dashboard/spec-lifecycle-time.js';
