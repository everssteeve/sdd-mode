...
import { calculerRiceMatrix, calculerImpactEffortEnAttente } from '../rice-matrix.js';
...
import { calculerEbmAires, calculerInvestmentBalance } from '../ebm-aires.js';
import { calculerHillCharts } from '../hill-charts.js';
import { calculerBilanHumainsAgents } from '../intent-humans-agents.js';
...
import { calculerBacklogHealthScore } from '../backlog-health-score.js';
...
import { collecterEcoMetrics } from '../../eco-dashboard.js';
...
export async function enrichir(racineProjet) {
  ...
  // Score composite (#561) — APRÈS ses 10 dépendances (freshness, hygiene,
  // outcomes, risques, décisions, hypothèses, annotations, vélocité SLA,
  // maturité, alignement), toutes déjà calculées ci-dessus.
  donnees.backlogHealthScore = calculerBacklogHealthScore(donnees);
  ...
  // Eco metrics (#030-4) — impact CO₂ des 30 dernières sessions LLM.
  donnees.ecoMetrics = collecterEcoMetrics(racineProjet);
  return donnees;
}
