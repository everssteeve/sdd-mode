...
import { blocSectionVisibility } from './section-visibility.js';
import { blocQuarterlyDecisions } from './quarterly-decisions.js';
import { blocSpecQualityScore } from './spec-quality-score.js';
import { blocSponsorScorecard } from './sponsor-scorecard.js';
import { blocOutcomeNorthStar } from './outcome-north-star.js';
import { blocActivityFeed } from './activity-feed.js';
import { blocInitiativeCards } from './initiative-cards.js';
import { blocSpecLifecycleTime } from './spec-lifecycle-time.js';
import { blocQuickFilters } from './quick-filters.js';
import { blocBacklogHealthScore } from './backlog-health-score.js';
...
.pm-progress-ok { background:#267336; }
.pm-progress-warn { background:#e8590c; }
.pm-progress-bad { background:#c92a2a; }
.pm-progress-label { position:absolute; inset:0; display:flex; align-items:center; justify-content:center; font-size:.7rem; font-weight:600; color:#fff; }
...
${blocBacklogHealthScore(donnees)}
...
${blocSponsorScorecard(donnees)}
${blocTagCloud(donnees)}
${blocTagClusters(donnees)}
${blocInitiativeCards(donnees)}
${blocDecisionLog(donnees)}
${blocQuarterlyDecisions(donnees)}
