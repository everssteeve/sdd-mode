...
.qc-btn { padding:.35rem .7rem; background:var(--accent, #4c6ef5); color:#fff; border-radius:.25rem; border:0; cursor:pointer; font-size:.85rem; font-weight:500; }
...
.qc-tab[aria-selected="true"] { background:var(--accent, #4c6ef5); color:#fff; border-color:var(--accent, #4c6ef5); }
</style>`;
