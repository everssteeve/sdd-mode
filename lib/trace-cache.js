...
//   }
//
// Le cache est ignoré silencieusement si la version change
// (`version` ≠ CACHE_VERSION) ou si le fichier est corrompu — on retombe
// simplement en re-scan complet.
//
...
// v2 : resserrement de `ANNOTATION_REGEX` (IDs strictement numériques) +
// marqueur `aiad-trace-ignore`. Les annotations parsées par la regex permissive
// v1 (placeholders `SPEC-NNN-…` captés à tort) doivent être invalidées à la
// mise à jour de l'outil. Bumper cette constante à chaque changement de la
// sémantique de parsing, pas seulement du format de cache.
