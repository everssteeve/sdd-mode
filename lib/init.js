...
${COULEURS.gras}  Commandes disponibles dans Claude Code :${COULEURS.reset}
  ...
  ${COULEURS.cyan}/sdd-fact${COULEURS.reset}          Capturer un écart livré/désiré
  ${COULEURS.cyan}/sdd-security${COULEURS.reset}      Audit sécurité (OWASP, secrets, permissions)
  ${COULEURS.cyan}/sdd-audit${COULEURS.reset}         Audit qualité (conformité SPEC, dette)
