...
export const DIMENSIONS = [
  { id: 'juridictions', label: 'EU jurisdictions', max: 20, desc: 'Diversité des juridictions EU couvertes par les packs gouvernance' },
  { id: 'agentsTier1', label: 'Tier 1 agents', max: 20, desc: 'Couverture réglementaire (4 baseline + bonus CRA/ISO/sectoriels)' },
  { id: 'langueFr', label: 'Language ratio FR', max: 20, desc: 'Proportion d\'artefacts en français (Intents + SPECs)' },
  { id: 'autorites', label: 'CNIL/ANSSI presence', max: 20, desc: 'Références explicites aux autorités françaises et européennes' },
  { id: 'hebergement', label: 'EU hosting commitment', max: 20, desc: 'Engagement explicite hébergement EU (publiccode/config/SECNUMCLOUD)' },
];
