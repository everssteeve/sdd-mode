...
- [ ] Code + lint passing
- [ ] Tests unitaires couvrant CA-001 à CA-008 (dont le rejeu sur les 67 SPEC archivées)
- [ ] Cas canary ajouté (CA-010)
- [ ] Annotations `@intent INTENT-033` / `@spec SPEC-033-3` / `@verified-by`
- [ ] SPEC mise à jour si écart (Drift Lock)
- [ ] Code review passée
- [ ] Gouvernance vérifiée (RGESN : zéro dépendance)
