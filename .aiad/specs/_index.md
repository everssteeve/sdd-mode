...
| SPEC-028-1 | Smoke test ESM bin/ (package.json + ci.yml) | INTENT-028 | prose | 5/5 | done | — |
| SPEC-028-2 | AGENT-GUIDE : section consommateurs de construireMatrice() | INTENT-028 | prose | 5/5 | done (trace-exempt) | — |
