...
| 2026-09-26 | `/aiad retro` et `/aiad intention` : l'étape « signaux d'évolution du framework » renvoyait à un processus interne ; elle devient « Retours sur le framework (optionnel) », partageables via une issue publique. Parité maintenue. | Audit pré-publication npm (INTENT-035). |
