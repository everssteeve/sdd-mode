...
- [x] [SPEC-027-1 — Stamp `validated_at` dans le frontmatter SPEC lors du passage `done`](./../specs/SPEC-027-1-stamp-validated-at.md)
- [x] [SPEC-027-2 — Fonction `calculateCycleTimeDaysFromSpec()` + flag CLI `--auto`](./../specs/SPEC-027-2-calculate-cycle-time.md)
- [x] [SPEC-027-3 — Steps CI post-deploy (`site-deploy.yml` + `release.yml`)](./../specs/SPEC-027-3-ci-workflow-steps.md)
