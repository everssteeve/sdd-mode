...
test('tier mapping snapshot', () => {
  const SNAPSHOT = {
    ...
    extended: ['adrs', 'ai-act', 'anonymize', 'archive', 'azure', 'backup', 'badge', 'bench', 'bitbucket', 'brief', 'cert', 'ci-template', 'completion', 'dinum', 'docs', 'dora', 'footprint', 'github-app', 'gitlab', 'hook-stats', 'hooks-init', 'marketplace', 'migrate', 'migrate-v2', 'negotiate', 'obsidian', 'offline', 'org', 'pii-scan', 'plugin', 'provenance', 'rbac', 'refactor-spec', 'reflect', 'repl', 'restore', 'schema', 'self-update', 'sla', 'sovereignty', 'spec-version', 'standup', 'storybook', 'suggest-annotations', 'suggest-tests', 'tour', 'track', 'tutorial', 'verify-reproducibility', 'webhooks', 'workspace'],
